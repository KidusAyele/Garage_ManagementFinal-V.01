...
namespace Garage_ManagementFinal.Controllers
{
    public class usersController : Controller
    {
        ...
        {
            var users = db.users.Where(o => o.role != "Admin");
        ...
        public ActionResult Create([Bind(Include = "Id,Firstname,Lastname,email,username,password,gender,phone_no,role,status,ResetPasswordCode")] user user)
        {
            if (ModelState.IsValid)
            {
                db.users.Add(user);
                db.SaveChanges();
                TempData["SuccessMessage"] = "User Created Successfuly!";
